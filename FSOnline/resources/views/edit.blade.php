...
<div class="container mt-5">
    ...
    <h1> Editeaza filmul - {{ $movie->name }}</h1>

    <div class="row">
        <form action="{{ route('movies.update', $movie->id) }}" method="post" class="form-validation form-styl-two" autocomplete="off">
            @method('PUT')
            ...
            <div class="col-sm-6 col-12">
                    <textarea placeholder="Descriere"
                              name="description"
                              class="@error('description') error @enderror">{{ $movie->description }}
                    </textarea>
